...
class DPGBA:
    ...
    def fit(self, features, edge_index, edge_weight, labels, idx_train, idx_attach,idx_unlabeled):
        ...
        optimizer_detector = optim.Adam(self.ood_detector.parameters(), lr=args.detector_lr, weight_decay=args.weight_decay)
        ...
        AE = MLPAE(features_select, self.device, args.rec_epochs)
        AE.fit()
